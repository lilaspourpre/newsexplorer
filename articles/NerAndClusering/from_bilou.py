        ...
        for index in range(len(list_of_tokens)):
            if not ((ne_tag is not None) ^ (ne_words != [])):
                ...
                if current_tag.startswith('B') or current_tag.startswith('I'):
                    dict_of_final_ne, ne_words, ne_tag = __check_bi(dict_of_final_ne, ne_words, ne_tag, current_tag,
                                                                     current_token)
                elif current_tag.startswith('L'):
                    dict_of_final_ne, ne_words, ne_tag = __check_l(dict_of_final_ne, ne_words, ne_tag, current_tag,
                                                                     current_token)
